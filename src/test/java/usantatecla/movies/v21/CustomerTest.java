...
public class CustomerTest {
	...
	public void regularRental1DayTest() {
		...
		RegularMovie movie = new MovieBuilder().title(movieName).regularMovie();
	...
	public void newReleaseRental1DayTest() {
		String movieName = "movieName";
		NewReleaseMovie movie = new MovieBuilder().title(movieName).newReleaseMovie();
		Rental rental = new RentalBuilder().movie(movie).daysRented(1).build();
		String customerName = "customerName";
		Customer customer = new CustomerBuilder().name(customerName).rental(rental).build();
	...
	public void childrensRental1DayTest() {
		String movieName = "movieName";
		ChildrenMovie movie = new MovieBuilder().title(movieName).childrenMovie();
		Rental rental = new RentalBuilder().movie(movie).daysRented(1).build();
		String customerName = "customerName";
		Customer customer = new CustomerBuilder().name(customerName).rental(rental).build();
	...
	public void rentalTest() {
		...
		RegularMovie regularMovie = new MovieBuilder().title(regularMovieName).regularMovie();
		...
		NewReleaseMovie newReleaseMovie = new MovieBuilder().title(newReleaseMovieName).newReleaseMovie();
		...
		ChildrenMovie childrensMovie = new MovieBuilder().title(childrensMovieName).childrenMovie();
